...
# โหลดโมเดล
def load_models():
    model_pm = joblib.load("D:/T_project/modelPM/model_PM25.pkl")
    model_temp = joblib.load("D:/T_project/modelPM/model_temperature.pkl")
    model_humidity = joblib.load("D:/T_project/modelPM/model_humidity.pkl")
    return model_pm, model_temp, model_humidity

# โหลดข้อมูล
def load_data():
    future_pm = pd.read_csv("D:/T_project/pm_2.5/future_pm_data_14days.csv")
    future_temp = pd.read_csv("D:/T_project/pm_2.5/future_temperature_data_14days.csv")
    future_humidity = pd.read_csv("D:/T_project/pm_2.5/future_humidity_data_14days.csv")
